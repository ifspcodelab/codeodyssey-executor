...
RABBITMQ_HOST = config['RABBITMQ_HOST_SECRET'] if config['RABBITMQ_HOST_SECRET'] else config['RABBITMQ_HOST']
RABBITMQ_PORT = config['RABBITMQ_PORT_SECRET'] if config['RABBITMQ_PORT_SECRET'] else config['RABBITMQ_PORT']
